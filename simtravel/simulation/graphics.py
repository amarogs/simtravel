...
class VisualRepresentation(object):
        ...
        def show_city(self):
            for i in range(self.SIZE):
                for j in range(self.SIZE):
                    ...
                    # elif self.city[i][j][3]==1:
                    #     self.canvas.create_rectangle(p1[0],p1[1], p2[0], p2[1], fill='yellow')
                    else:
                        self.canvas.create_rectangle(
        ...
        def show_components(self, segments):
            color = ["red", "green", "blue", "yellow", "orange", "gray", "pink", "black"]
            ...
            for i in range(self.SIZE):
                for j in range(self.SIZE):
                    ...
                    if in_segment != -1: 
                        self.canvas.create_rectangle(p1[0], p1[1], p2[0], p2[1], fill=color[k%len(color)])
                    else:
                        self.canvas.create_rectangle( p1[0], p1[1], p2[0], p2[1], fill='white')
